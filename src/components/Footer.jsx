...
<footer className="bg-gray-200 text-gray-900 bg-neutral-primary">
    ...
    <div className="px-4 py-6 bg-neutral-secondary-soft md:flex md:items-center md:justify-between">
        <span className="text-sm text-body sm:text-center">© 2025 <a href="https://swiggy.com/">Swiggy</a>. All Rights Reserved.
        </span>
